-- Migration: Add foreign key from chat_messages.sender_id to profiles.id for PostgREST expansion
...
-- (Optional) If you want firefighters to also participate, add this to the OR clause above:
-- OR EXISTS (
